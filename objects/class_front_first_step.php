...
class laundry_first_step
{
 ...
 $query="SELECT `start_date_time`,`end_date_time` FROM `".$this->table_name4."` where provider_id = '".$staff_id."'" ;
    ...
    function get_day_time_slot_by_provider_id($provider_schedule_type, $start_date, $time_int,$advance_bookingtime=0,$service_padding_before=0,$service_padding_after=0,$timezonediff=0,$booking_padding_time=0,$staff_id=null)    
    {
